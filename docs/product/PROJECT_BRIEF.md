...
5. 주요 일정에서 가격지수·거래현황, 미분양·공급, 금리, 청약, 정책·공시가격 발표 시점을 확인하고, 실거래 공개는 freshness/status로 확인합니다.
...
- 주요 일정: 공식 통계, 거래현황, 미분양·공급, 금리, 청약, 정책·공시가격 발표 일정을 관리하고, 실거래 공개는 freshness/status로 분리합니다.
