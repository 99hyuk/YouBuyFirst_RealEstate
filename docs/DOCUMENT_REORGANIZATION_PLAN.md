...
| `docs/CHAT_START_GUIDE.md` | `docs/layers/ops/CHAT_START_GUIDE.md` | 채팅 시작 절차이므로 ops 레이어입니다. |
| `docs/CONTEXT.md` | `docs/current/CONTEXT.md` 또는 archive | 현재 `CURRENT_HANDOFF.md`와 중복 여부 확인 후 병합/폐기 후보입니다. |
| `docs/CURRENT_HANDOFF.md` | `docs/current/HANDOFF.md` | 현재 상태 정본입니다. |
| `docs/TASKS.md` | `docs/current/TASKS.md` | 다음 작업 후보 정본입니다. |
| `docs/DOCUMENTATION_GUIDE.md` | `docs/layers/ops/DOCUMENTATION_GUIDE.md` | 문서 운영 기준입니다. |
| `docs/DOMAIN_PACKAGE_GUIDE.md` | `docs/layers/ops/DOMAIN_PACKAGE_GUIDE.md` 또는 domain README에 분배 | 코드 패키지 경계 안내입니다. 일부는 domain README로 흡수할 수 있습니다. |
| `docs/ENGINEERING_EVIDENCE_GUIDE.md` | `docs/layers/ops/ENGINEERING_EVIDENCE_GUIDE.md` | 기술 경험 기록 운영 기준입니다. |
| `docs/GIT_CONVENTION.md` | `docs/layers/ops/GIT_CONVENTION.md` | PR/Git 운영 기준입니다. |
| `docs/LABEL_GUIDE.md` | `docs/layers/ops/LABEL_GUIDE.md` | 라벨 운영 기준입니다. |
| `docs/WORKFLOW.md` | `docs/layers/ops/WORKFLOW.md` | 작업 흐름 운영 기준입니다. |
| `docs/FINAL_PRODUCT_PLAN.md` | `docs/product/FINAL_PRODUCT_PLAN.md` | 제품 장기 정본입니다. |
| `docs/PRODUCT_DECISION_NOTES.md` | `docs/product/PRODUCT_DECISION_NOTES.md` | 제품/기술 고민 색인입니다. |
| `docs/PROJECT_BRIEF.md` | `docs/product/PROJECT_BRIEF.md` | MVP 요약입니다. |
| `docs/COMMUNITY_REACTION_GUIDE.md` | `docs/domains/community/REACTION_GUIDE.md` | 커뮤니티 반응 용어/지표 정본입니다. |
| `docs/STOCK_DETAIL_COPY_GUIDE.md` | `docs/domains/agent/STOCK_DETAIL_HEADLINE.md`와 `docs/layers/ui/STOCK_DETAIL_BANNER.md`로 분리 | 헤드라인 생성 기준은 agent 도메인, 검은 배너 UI/레퍼런스는 UI 레이어가 소유합니다. |
| `docs/LEGAL_RISK_CASES.md` | `docs/governance/LEGAL_RISK_CASES.md` | 정책/법적 리스크 관리 문서입니다. |
| `docs/TECHNICAL_RISK_REGISTER.md` | `docs/governance/TECHNICAL_RISK_REGISTER.md` | 리스크 레지스터입니다. |
| `docs/TROUBLESHOOTING_GUIDE.md` | `docs/governance/TROUBLESHOOTING_GUIDE.md` | 장애/문제 대응 기록 기준입니다. |
| `docs/workstreams/README.md` | `docs/layers/ops/TRACKS.md` | 트랙은 실행 라벨로 유지합니다. |
...
| `docs/workstreams/market/README.md` | `docs/domains/market/README.md` | market 도메인 정본입니다. |
| `docs/workstreams/market/chart-candles.md` | `docs/domains/market/CHART_CANDLES.md` | market contract입니다. |
| `docs/workstreams/market/investor-flows.md` | `docs/domains/market/INVESTOR_FLOWS.md` | market contract입니다. |
| `docs/workstreams/market/quote-snapshot.md` | `docs/domains/market/QUOTE_SNAPSHOT.md` | market contract입니다. |
...
| `docs/workstreams/front/README.md` | `docs/layers/ui/README.md` | UI 레이어 정본입니다. |
| `docs/workstreams/front/DESIGN_SYSTEM.md` | `docs/layers/ui/DESIGN_SYSTEM.md` | UI 레이어 정본입니다. |
| `docs/workstreams/front/WIREFRAME_HANDOFF.md` | `docs/layers/ui/WIREFRAME_HANDOFF.md` 또는 current 링크 | UI 현재 작업과 겹치므로 이관 시 최신성 확인이 필요합니다. |
...
| `docs/workstreams/front/VISUAL_CHANGELOG.md` | `docs/layers/ui/VISUAL_CHANGELOG.md` | UI 변경 이력입니다. 최근 항목만 유지하는 후보입니다. |
| `docs/workstreams/front/screens/` | `docs/layers/ui/screens/` | 화면별 Screen Brief 정본입니다. |
| `docs/workstreams/front/archive/` | `docs/archive/front/` | 과거 front 기록입니다. |
| `docs/workstreams/ops/README.md` | `docs/layers/ops/README.md` | ops 레이어 정본입니다. |
| `docs/work-units/` | `docs/archive/work-units/` | PR/작업 단위 과거 기록입니다. |
| `docs/superpowers/` | `docs/archive/superpowers/` | 과거 설계/실행 계획 archive입니다. |
