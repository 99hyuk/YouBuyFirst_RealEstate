...
ops는 문서 구조, Git/PR, Notion 기록, 트랙 조율, 브랜치/worktree 생명주기, 컨텍스트 예산을 소유합니다.

세부 실행 규칙은 중복하지 않습니다. 작업 시작은 `AGENTS.md`, 문서 구조는 `DOCUMENTATION_GUIDE.md`, 브랜치/PR은 `WORKFLOW.md`와 `GIT_CONVENTION.md`, 라벨은 `LABEL_GUIDE.md`, 트랙 경계는 `TRACKS.md`를 봅니다.
...
- 운영 문서와 인수인계 문서
- 트랙별 PR/Notion 상태와 main 통합 시점 점검
