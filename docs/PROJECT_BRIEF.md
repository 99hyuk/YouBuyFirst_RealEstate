...
- 공개 화면은 원문보다 집계 지표, 대표 키워드, 감성 비율, AI 재서술 근거를 중심으로 설계합니다.
...
최종 제품에는 커뮤니티별 수익률 비교 에이전트, 시세/호가 기반 투자 참고 화면, 모의투자/AI 에이전트, OCR 자산 연동이 포함됩니다. 병렬 작업 트랙은 `docs/workstreams/README.md`를 기준으로 나눕니다.
