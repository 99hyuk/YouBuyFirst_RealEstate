...
_KNOWN_METADATA = {
    ...
    "454910.KS": InstrumentMetadata("454910.KS", "Doosan Robotics", "KR", "KRW"),
    "035420.KS": InstrumentMetadata("035420.KS", "NAVER", "KR", "KRW"),
    "086520.KQ": InstrumentMetadata("086520.KQ", "Ecopro", "KR", "KRW"),
    "042700.KS": InstrumentMetadata("042700.KS", "Hanmi Semiconductor", "KR", "KRW"),
    "066570.KS": InstrumentMetadata("066570.KS", "LG Electronics", "KR", "KRW"),
    "005380.KS": InstrumentMetadata("005380.KS", "Hyundai Motor", "KR", "KRW"),
    "006400.KS": InstrumentMetadata("006400.KS", "Samsung SDI", "KR", "KRW"),
    "035720.KS": InstrumentMetadata("035720.KS", "Kakao", "KR", "KRW"),
    "051910.KS": InstrumentMetadata("051910.KS", "LG Chem", "KR", "KRW"),
    "068270.KS": InstrumentMetadata("068270.KS", "Celltrion", "KR", "KRW"),
    "105560.KS": InstrumentMetadata("105560.KS", "KB Financial Group", "KR", "KRW"),
    "055550.KS": InstrumentMetadata("055550.KS", "Shinhan Financial Group", "KR", "KRW"),
    "005490.KS": InstrumentMetadata("005490.KS", "POSCO Holdings", "KR", "KRW"),
    "207940.KS": InstrumentMetadata("207940.KS", "Samsung Biologics", "KR", "KRW"),
    "247540.KQ": InstrumentMetadata("247540.KQ", "Ecopro BM", "KR", "KRW"),
    "035900.KQ": InstrumentMetadata("035900.KQ", "JYP Entertainment", "KR", "KRW"),
    "196170.KQ": InstrumentMetadata("196170.KQ", "Alteogen", "KR", "KRW"),
    "133690.KS": InstrumentMetadata("133690.KS", "TIGER 200", "KR", "KRW"),
    "102110.KS": InstrumentMetadata("102110.KS", "TIGER 200", "KR", "KRW"),
    "AAPL": InstrumentMetadata("AAPL", "Apple", "US", "USD"),
    "MSFT": InstrumentMetadata("MSFT", "Microsoft", "US", "USD"),
    "NVDA": InstrumentMetadata("NVDA", "NVIDIA", "US", "USD"),
    "TSLA": InstrumentMetadata("TSLA", "Tesla", "US", "USD"),
    "AMZN": InstrumentMetadata("AMZN", "Amazon", "US", "USD"),
    "GOOGL": InstrumentMetadata("GOOGL", "Alphabet", "US", "USD"),
    "META": InstrumentMetadata("META", "Meta Platforms", "US", "USD"),
    "NFLX": InstrumentMetadata("NFLX", "Netflix", "US", "USD"),
    "AVGO": InstrumentMetadata("AVGO", "Broadcom", "US", "USD"),
    "AMD": InstrumentMetadata("AMD", "Advanced Micro Devices", "US", "USD"),
    "JPM": InstrumentMetadata("JPM", "JPMorgan Chase", "US", "USD"),
    "BRK-B": InstrumentMetadata("BRK-B", "Berkshire Hathaway", "US", "USD"),
    "SOFI": InstrumentMetadata("SOFI", "SoFi Technologies", "US", "USD"),
    "PLTR": InstrumentMetadata("PLTR", "Palantir", "US", "USD"),
    "TSM": InstrumentMetadata("TSM", "Taiwan Semiconductor Manufacturing", "US", "USD"),
    "SMR": InstrumentMetadata("SMR", "NuScale Power", "US", "USD"),
    "SPY": InstrumentMetadata("SPY", "SPDR S&P 500 ETF Trust", "US", "USD"),
    "QQQ": InstrumentMetadata("QQQ", "Invesco QQQ Trust", "US", "USD"),
    "SOXS": InstrumentMetadata("SOXS", "Direxion Daily Semiconductor Bear 3X Shares", "US", "USD"),
    "MSFU": InstrumentMetadata("MSFU", "Direxion Daily MSFT Bull 2X Shares", "US", "USD"),
}
