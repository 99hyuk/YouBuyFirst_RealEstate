...
PUBLIC_DATA_DATASETS: tuple[PublicDataDataset, ...] = (
    ...
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="오피스텔 매매 실거래가",
        fact_type="offi_trade",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcOffiTrade/getRTMSDataSvcOffiTrade",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based officetel sale transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="오피스텔 전월세 실거래가",
        fact_type="offi_rent",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcOffiRent/getRTMSDataSvcOffiRent",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based officetel rent transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="연립다세대 매매 실거래가",
        fact_type="rh_trade",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcRHTrade/getRTMSDataSvcRHTrade",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based rowhouse/multifamily sale transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="연립다세대 전월세 실거래가",
        fact_type="rh_rent",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcRHRent/getRTMSDataSvcRHRent",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based rowhouse/multifamily rent transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="단독다가구 매매 실거래가",
        fact_type="sh_trade",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcSHTrade/getRTMSDataSvcSHTrade",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based single/multifamily house sale transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="단독다가구 전월세 실거래가",
        fact_type="sh_rent",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcSHRent/getRTMSDataSvcSHRent",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based single/multifamily house rent transactions.",
    ),
    PublicDataDataset(
        ...
        provider_name="국토교통부",
        owner_org="국토교통부",
        display_name="분양권 매매 실거래가",
        fact_type="silv_trade",
        access_method="openapi",
        format="xml",
        source_url="https://apis.data.go.kr/1613000/RTMSDataSvcSilvTrade/getRTMSDataSvcSilvTrade",
        ...
        backfill_required=True,
        enabled_for_backfill=True,
        notes="LAWD_CD and DEAL_YMD based presale-right sale transactions.",
    ),
    PublicDataDataset(
