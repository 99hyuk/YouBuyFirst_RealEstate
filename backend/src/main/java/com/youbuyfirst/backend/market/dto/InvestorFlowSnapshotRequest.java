...
public record InvestorFlowSnapshotRequest(
        ...
        @NotBlank @Size(max = 200) String sourceLabel,
        @NotBlank @Size(max = 120) String delayLabel,
        @NotNull Instant asOf,
        @NotBlank @Size(max = 30) String dataStatus,
        @NotNull @Valid InvestorFlowLegRequest individual,
        @NotNull @Valid InvestorFlowLegRequest foreign,
        @NotNull @Valid InvestorFlowLegRequest institution
) {
}
